...
import type { Amount, Code } from '@composable/types/interfaces/cosmwasm';
...
declare module '@polkadot/rpc-core/types/jsonrpc' {
    interface RpcInterface {
        ...
        cosmwasm: {
             ...
             * Call a contract
             **/
            call: AugmentedRpc<(origin: AccountId32 | string | Uint8Array, dest: AccountId32 | string | Uint8Array, value: BTreeMap<CustomRpcCurrencyId, Amount>, gas_limit: u64 | AnyNumber | Uint8Array, storage_deposit_limit: Option<CustomRpcBalance> | null | object | string | Uint8Array, data: Bytes | string | Uint8Array, at?: Hash | string | Uint8Array) => Observable<ContractExecResult>>;
            /**
             * Instantiate a contract
             **/
            instantiate: AugmentedRpc<(origin: AccountId32 | string | Uint8Array, value: BTreeMap<CustomRpcCurrencyId, Amount>, gas_limit: u64 | AnyNumber | Uint8Array, storage_deposit_limit: Option<CustomRpcBalance> | null | object | string | Uint8Array, code: Code | {
                Upload: any;
            } | {
                Existing: any;
            } | string | Uint8Array, data: Bytes | string | Uint8Array, salt: Bytes | string | Uint8Array, at?: Hash | string | Uint8Array) => Observable<ContractInstantiateResult>>;
            /**
             * Query a contract
             **/
